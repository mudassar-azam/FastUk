...
<body class="home page-template page-template-home page-template-home-php page page-id-43 wp-custom-logo">
    ...
    <section class="w-full custom-form-container mt-72 lg:mt-0"
        style="padding: 0!important; background-color: #ffffff!important;">
        <div class="container lg:flex" style="flex-direction: row-reverse;">
            <div class="lg:w-6/12 p-10 pb-0">
                <div role="form" class="wpcf7" id="wpcf7-f98-o1" lang="en-US" dir="ltr">
                    ...
                    <div class="custom-cf7-form">
                        ...
                        <form action="{{ route('tradeaccountform') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="mx-2 mt-5">
                                <label class="flex-1 input-container">
                                    Company Name:
                                    <input type="text" name="company_name" value="" size="40"
                                        class="mb-4" aria-required="true" aria-invalid="false"
                                ...
                                <label class="flex-1 input-container">
                                    ...
                                    <span class="wpcf7-form-control-wrap your-message">
                                        <textarea name="trading_address" rows="3" class="mb-4" size="40" style="height: initial;width: 100%;"
                                            aria-invalid="false" placeholder="Trading Address"></textarea>
                                    </span>
                                </label>
                                <label class="flex-1 input-container">
                                    Email:
                                ...
                                <label class="flex-1 input-container">
                                    Telephone:
                                    <input type="number" name="phone" value="" class="mb-4"
                                        aria-invalid="false" placeholder="Phone number" />
                                </label>
                                <label class="flex-1 input-container">
                                    Invoice Address:
                                    <span class="wpcf7-form-control-wrap your-message">
                                        <textarea name="invoice_address" rows="3" class="mb-4" size="40" style="height: initial;width: 100%;"
                                            aria-invalid="false" placeholder="If same as trading address please leave blank."></textarea>
                                    </span>
                                </label>
                                <label class="flex-1 input-container">
                                    Accounts Email:
                                    <input type="email" name="account_email" value="" size="40"
                                        class="mb-4" aria-required="true" aria-invalid="false"
                                        placeholder="Email" />
                                </label>
                                <label class="flex-1 input-container">
                                    Accounts Telephone:
                                    <input type="number" name="account_phone" value="" class="mb-4"
                                        aria-invalid="false" placeholder="Phone number" />
                                </label>
                                <label class="flex-1 input-container">
                                    Company Number:
                                    <input type="number" name="company_number" value="" class="mb-4"
                                        aria-invalid="false" placeholder="Company number" />
                                </label>
                                <label class="flex-1 input-container">
                                    VAT Number:
                                    <input type="text" name="vat_number" value="" class="mb-4"
                                        aria-invalid="false" placeholder="VAT number" />
                                </label>
                                <label class="flex-1 input-container">
                                    Terms of Payment (30 Days Net):
                                    <span class="wpcf7-form-control-wrap your-message">
                                        <textarea name="payment_terms" rows="3" class="mb-4" size="40" style="height: initial;width: 100%;"
                                            aria-invalid="false" placeholder="If your payment terms are different then please state accordingly."></textarea>
                                    </span>
                                </label>
                                <label class="flex-1 input-container">
                                    Date:
                                    <input type="date" name="date" value="" class="mb-4"
                                        aria-invalid="false" placeholder="Date" />
                                </label>
                                <label class="flex-1 input-container">
                                    Name and Position:
                                    <input type="text" name="name_position" value="" size="40"
                                        class="mb-4" aria-required="true" aria-invalid="false"
                                            ...
                                            <span class="wpcf7-list-item">
                                                <label>
                                                    ...
                                                    <span class="wpcf7-list-item-label">
                                                        I agree to set up an account with Fast UK Couriers.
                                                    </span>
                                ...
                                <p>
                                    <button type="submit"
                                        class="mb-5 wpcf7-form-control has-spinner send-submit">Send Message</button>
                                </p>
                            </div>
            ...
            <!-- Add this in your Blade file, e.g., resources/views/your-form.blade.php -->
            ...
            <div class="lg:w-6/12 px-10 py-10">
                <div>
                    <h1 class=" text-5xl mb-4 mt-4" style="color: #AA1818;"><strong>Set Up An Account&nbsp;</strong>
                    </h1>
                    <style>
                        #refund-list>li {
                            margin-top: 10px;
                    ...
                    <ol class="" id="refund-list">
                        <li> <!--<h3 class="font-bold"><strong>Eligibility for Refunds:&nbsp;</strong></h3>   -->
                            <br />

                            <strong class="font-bold">Please fill in all the requested details and one of our transport
                                team will be in touch very shortly.</strong>
                            <br />
                            <br />
                            <br />
                            <hr style="border-top: 1px solid #AA1818;">

                        </li>
                        <br />
                        <p style="font-size: 0.95rem;">Fast UK Couriers is committed to protecting and respecting your
                            privacy, and we’ll only use your personal information to administer your account and to
                            provide the products and services you requested from us. From time to time, we would like to
                            contact you about our products and services, as well as other content that may be of
                            interest to you.</p>

                        </li>
                        <li>
                            <p style="font-size: 0.95rem;">You can unsubscribe from these communications at any time.
                                By clicking submit below, you consent to allow Fast UK Couriers to store and process the
                                personal information submitted above to provide you the content requested.</p>

                        </li>
                        <li>
                            <p style="font-size: 0.95rem;"><strong>Our full terms and conditions of carriage can be
                                    found <a href="{{ url('terms-conditions') }}"
                                        style="color: #AA1818;text-decoration: underline;">here</a>.</strong></p>
                        </li>
                        <li>
                            <br />
                            <hr style="border-top: 1px solid #AA1818;">
