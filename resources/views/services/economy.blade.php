...
<header style="background-color:#ab1818;position:sticky;top:0;">
    <div class="container-fluid">
        <div class="container">
                ...
                <div class='col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10'>
                    <ul class="nav navbar nav-expand-lg nav-expand-md">
                        ...
                        <li class="nav-items position-relative">
                            <a href="{{url('/ecconomy same day delivery service')}}" class="nav-link text-white service" style="word-spacing:3px;">ecconomy same day delivery service <i class="fas fa-angle-down"></i></a>

                            <div id="main-dropdown-one" style="position:absolute;background-color:#ab1818;width:200px;height:auto;">
                                <ul class="nav navbar flex-column justify-content-start align-items-start">
                                    <li class="nav-items"><a href="#" class="nav-link text-white text-left">List one</a></li>
                                    <li class="nav-items"><a href="#" class="nav-link text-white text-left">List Two</a></li>
                                </ul>
                            </div>

                        </li>
                        <li class="nav-items position-relative">
                            <a href="{{url('/industries')}}" class="nav-link text-white industries" style="word-spacing:3px;">Industries <i class="fas fa-angle-down"></i></a>
                            <div id="main-dropdown-two" style="position:absolute;background-color:#ab1818;width:200px;height:auto;">
                                <ul class="nav navbar flex-column justify-content-start align-items-start">
                                    <li class="nav-items"><a href="#" class="nav-link text-white text-left">List one</a></li>
                                    <li class="nav-items"><a href="#" class="nav-link text-white text-left">List Two</a></li>
                                </ul>
                        ...
                        <li class="nav-items"><a href="#" class="nav-link text-white">Tracking</a></li>
                        <li class="nav-items"><a href="#" class="nav-link text-white">About Us</a></li>
                        <li class="nav-items"><a href="#" class="nav-link text-white">Our fleet</a></li>
                        <li class="nav-items"><a href="#" class="nav-link text-white">Contact Us</a></li>
            ...
            <div class="row  d-xl-none d-lg-none d-md-flex d-sm-flex d-flex py-2 align-items-center py-2">
                <div class="col-6">
                    <img src="{{asset('public/images/flogo.png')}}" alt="company-logo" class="img-fluid" style="width:90px;height:auto;">
                </div>
                ...
                <div id="navDropdown">
                    ...
                    <ul class="nav navbar flex-column">
                            <li class="nav-items active"><a href="#" class="nav-link text-white">Home</a></li>
                            <li class="nav-items position-relative">
                                <a href="#" class="nav-link text-white service" style="word-spacing:6px;">Service <i class="fas fa-angle-down"></i></a>
                                <div id="main-dropdown-one" style="position:absolute;background-color:#ab1818;width:200px;height:auto;">
                                    <ul class="nav navbar flex-column justify-content-start align-items-start">
                                        <li class="nav-items"><a href="#" class="nav-link text-white text-left">List one</a></li>
                                        <li class="nav-items"><a href="#" class="nav-link text-white text-left">List Two</a></li>
                            ...
                            <li class="nav-items position-relative industries">
                                <a href="#" class="nav-link text-white" style="word-spacing:7px;">Industries <i class="fas fa-angle-down"></i></a>
                                <div id="main-dropdown-one" style="position:absolute;background-color:#ab1818;width:200px;height:auto;">
                                    <ul class="nav navbar flex-column justify-content-start align-items-start">
                                        <li class="nav-items"><a href="#" class="nav-link text-white text-left">List one</a></li>
                                        <li class="nav-items"><a href="#" class="nav-link text-white text-left">List Two</a></li>
 ...
 background-repeat:no-repeat; background-size:cover;margin-top:-49px;background-attachment:fixed;background-position:center;">
    <div class="row justify-content-center align-items-center">
        <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 text-xl-left text-lg-left text-md-left text-sm-center text-center p-0 mt-3 mb-2">
            <div class="display-3 text-center font-weight-bold">Service</div>
            <div class="text-big"><a href="#" class="text-decoration-none font-weight-bold text-white" style="color:#ab1818 !important;">Home</a> / <a href="#" class="text-decoration-none text-white font-weight-bold" style="color:#ab1818 !important;">service</a></div>
        </div>
    </div>
</div>
