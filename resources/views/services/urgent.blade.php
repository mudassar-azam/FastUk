                ...
                <div class='col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10'>
                    <ul class="nav navbar nav-expand-lg nav-expand-md">
                        ...
                        <li class="nav-items position-relative">
                            <a href="{{url('/urgent same day courier service')}}" class="nav-link text-white service" style="word-spacing:3px;">urgent same day courier service <i class="fas fa-angle-down"></i></a>
