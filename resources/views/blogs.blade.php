...
<head>
    ...
    <link rel='stylesheet' href='{{ asset('public/public/assets_front/new/css/contact7.css') }}' type='text/css' media='all' />
    ...
    <style type="text/css" id="wp-custom-css">
       ...
       /* Target the h1 element with the id "blogs-heading" */
       #blogs-heading {
        font-size: 50px;
        text-align: center;
        font-weight: bold;
        ...
        /* The container holding the blog cards */
.container {
    max-width: 1200px;
    margin: 0 auto;
    padding: 20px;
...
.col-md-4 {
    width: calc(33.33% - 20px); /* Three cards in a row, with 20px spacing */
    margin-bottom: 20px;
}
...
@media (max-width: 992px) {
    .col-md-4 {
        width: calc(50% - 20px); /* Two cards in a row, with 20px spacing */
    }
}
            ...
            @foreach ($blogs as $blog)
                <div class="col-md-4 mb-4">
                    <div class="card h-100 position-relative">
                        <img class="card-img-top" src="{{ asset('public/featureimages') }}/{{ $blog->featureimage }}"
                            alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">
                                {{ $blog->category }}
                            ...
                            <!-- Edit Button -->
                            <a href="{{ url('blogdetail', ['id' => $blog->id]) }}" class="btn btn-primary">Detail</a>
                            <!-- Delete Button -->
                        </div>
                    </div>
                </div>
