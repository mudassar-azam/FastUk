 ...
 background-repeat:no-repeat; background-size:cover;margin-top:-49px;background-attachment:fixed;background-position:center;">
    <div class="row justify-content-center align-items-center">
        <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7 text-xl-left text-lg-left text-md-left text-sm-center text-center p-0 mt-3 mb-2">
            <div class="display-3 text-center font-weight-bold">About Us</div>
            <div class="text-big"><a href="#" class="text-decoration-none font-weight-bold text-white" style="color:#ab1818 !important;">Home</a> / <a href="#" class="text-decoration-none text-white font-weight-bold" style="color:#ab1818 !important;">About-us</a></div>
        </div>
    </div>
</div>
	...
	<div class="position-fixed rounded rounded-circle bg-primary d-flex justify-content-center align-items-center" style="bottom:35px;right:35px;width:80px;height:80px;padding:10px;cursor:pointer;" id="sms-a">
	   <div class="text-white">
	      <i class="fas fa-comment-dots" style="font-size:40px;" id="smsIcon-a"></i>
	      <i class="fas fa-times" style="font-size:40px;display:none;" id="close-a"></i>
	   </div>
	</div>
	<div class="position-fixed bg-primary m-0 p-0 shadow-lg" style="border-radius:20px;bottom: 112px;right: 108px;padding:10px;cursor:pointer;width:300px;height:auto;z-index:9999;overflow:hidden;display:none;" id="smsBox-a">
...
<script>
    ...
    $(document).ready(function(){
        $("#sms-a").on('click',function(){
            $("#smsBox-a").slideToggle("fast");
            $("#close-a").toggle("fast");
            $("#smsIcon-a").toggle("fast");
        });
    });
