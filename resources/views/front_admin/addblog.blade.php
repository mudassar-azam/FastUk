            ...
            <div class="container">
                ...
                <form action="{{ Route('blog.storeblog') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control1" id="myfield" name="meta_description" rows="5"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control1" id="myfield" name="content" rows="5"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="subimages" name="subimages[]" multiple>
                    </div>
