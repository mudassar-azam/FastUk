...
background-image:url('banner1.png');
 background-repeat:no-repeat; background-size:cover;margin-top:-49px;background-attachment:fixed;background-position:center;">
	...
	<div class="position-fixed rounded rounded-circle bg-primary d-flex justify-content-center align-items-center" style="bottom:35px;right:35px;width:80px;height:80px;padding:10px;cursor:pointer;" id="sms-i">
	   <div class="text-white">
	      <i class="fas fa-comment-dots" style="font-size:40px;" id="smsIcon-i"></i>
	      <i class="fas fa-times" style="font-size:40px;display:none;" id="close-i"></i>
	   </div>
	</div>
	<div class="position-fixed bg-primary m-0 p-0 shadow-lg" style="border-radius:20px;bottom: 112px;right: 108px;padding:10px;cursor:pointer;width:300px;height:auto;z-index:9999;overflow:hidden;display:none;" id="smsBox-i">
...
<script>
    ...
    $(document).ready(function(){
        $("#sms-i").on('click',function(){
            $("#smsBox-i").slideToggle("fast");
            $("#close-i").toggle("fast");
            $("#smsIcon-i").toggle("fast");
        });
    });
