        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">List of Guest Bookings</h4>
                            <!-- <h6 class="card-subtitle">Export data to Copy, CSV, Excel, PDF & Print</h6> -->
                            <div class="table-responsive m-t-10">
                                <?php
                                $tab_requete[] = array();
                                //                                $tab_requete = getRequete();
                                $tab_requete = get_guestBooking();
                                ...
                                <table id="example24" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    foreach ($tab_requete as $tab_requetes) {
                                        ...
                                        echo'
                                             ...
                                             <a href="query/ajax/action.php?id_single_gb_delete='.$tab_requetes['booking_id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>

                                             <select  class="gb_ch_sts"  data-usrid="'.$tab_requetes['booking_id'].'" ><option readonly disabled selected>Change Status</option><option value="complete">Complete</option><option value="pending">Pending</option><option value="inprogress">In Progress</option><option value="cancel">Cancel</option></select>
                                    ...
                                    ?>
<!--                                    <button type="button"  class="btn btn-warning btn-sm" data-original-title="Modifier" data-toggle="modal" data-target="#annee-mod"><i class="fa fa-pencil"></i></button>-->
...
<script>
    ...
    $('.gb_ch_sts').on('change', function(){    // 2nd (A)
        var val=$(this).val();
        var id=$(this).data('usrid');
        // alert(id);
        window.location.href="query/ajax/action.php?gb_ch_sts=gb&st="+val+"&id="+id;
