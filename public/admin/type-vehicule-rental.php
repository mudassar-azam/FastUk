                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 m-b-0">
                                                              ...
                                                              <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">Miles</label>
                                                                    <input type="text" class="form-control " placeholder="" name="miles_vehicule_rental_mod" id="miles_vehicule_rental_mod" required> 
                                                            ...
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">Image</label>
                                                                    <input type="file" class="form-control" placeholder="" name="image_vehicule_rental_mod" id="image_vehicule_rental_mod"> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
        ...
        function modTypeVehicule(id_type){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#miles_vehicule_rental_mod").val(data_parse[0].miles);
                }
            });
        }
    </script>
