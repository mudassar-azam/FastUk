...
<!--                                        <th width="10%">Actions</th>-->
                                    ...
                                    for($i=0; $i<count($tab_conducteur); $i++){
                                        echo'
                                                        <tr>
                                                            <td>'.($i+1).'</td>
                                                            <td>'.$tab_conducteur[$i]['track_id'].'</td>
                                                               <td>

                                                                <input type="hidden" value="'.$tab_conducteur[$i]['id'].'" name="" id="id_conducteur_'.$i.'">

                                                            <a href="query/ajax/action.php?id_guest_delete='.$tab_conducteur[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
