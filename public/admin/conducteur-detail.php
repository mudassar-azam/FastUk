                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="" class="label-detail-title">Licence Front :</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="" class="label-detail-title">Licence Back:</label>
                                                </td>
                                                <td>
                                                    <img class="m-l-40 p-10" src="on_demand_taxi_webservice/images/app_user/<?php echo $tab_driver_info[0]['photo_licence_path_back']; ?>" alt="" width="50%">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <label for="" class="label-detail-title">NIC Front:</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <label for="" class="label-detail-title">NIC Black:</label>
                                                </td>
                                                <td>
                                                    <img class="m-l-40 p-10" src="on_demand_taxi_webservice/images/app_user/<?php echo $tab_driver_info[0]['photo_nic_path_back']; ?>" alt="" width="50%">
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
